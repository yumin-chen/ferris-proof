    ...
    match action {
        CacheAction::Info => {
            ...
            if info.total_entries == 0 {
                ...
                println!("\n⚠️  {} expired entries found. Consider running 'ferris-proof cache cleanup'", info.expired_entries);
            } else {
                println!("\n✅ Cache is healthy.");
            }
        }
        ...
        CacheAction::Cleanup => {
            ...
            if result.entries_removed == 0 {
                ...
                println!("✅ Successfully cleaned up {} expired entries.", result.entries_removed);
            }
        }
        ...
        CacheAction::Health => {
            ...
            println!("  Disk size: {}", format_bytes(health_report.info.disk_size_bytes));
        ...
        CacheAction::Repair => {
            ...
            println!("  Corrupted entries removed: {}", result.corrupted_entries_removed);
            println!("  Entries before: {}", result.entries_before);
            println!("  Entries after: {}", result.entries_after);
            println!("  Size freed: {}", format_bytes(result.size_freed));

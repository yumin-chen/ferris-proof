...
fn create_error_catalog() -> HashMap<String, ErrorExplanation> {
    ...
    catalog.insert("FP-CF-001".to_string(), ErrorExplanation {
        title: "Invalid Verification Level".to_string(),
        description: "The specified verification level in the configuration is not recognized.".to_string(),
        causes: vec![
    ...
    catalog.insert("FP-CF-003".to_string(), ErrorExplanation {
        title: "Conflicting Module-Level Overrides".to_string(),
        description: "Multiple glob patterns match the same module, creating conflicting configurations.".to_string(),
        causes: vec![
        ...
        examples: vec![
            "# Conflicting patterns:\n[modules.\"crypto::*\"]\n[modules.\"crypto::aes::*\"]".to_string(),
        ],
        related_codes: vec!["FP-CF-001".to_string()],
    });
    
    // Verification Errors (FP-VR-xxx)
    catalog.insert("FP-VR-001".to_string(), ErrorExplanation {
        title: "Property Test Failure".to_string(),
        description: "A property-based test found a counterexample that violates the specified property.".to_string(),
        causes: vec![
        ...
        examples: vec![
            "Property: addition is commutative\nCounterexample: a=MAX_INT, b=1 (overflow)".to_string(),
        ],
    ...
    catalog.insert("FP-TL-001".to_string(), ErrorExplanation {
        title: "TLA+ TLC Not Found".to_string(),
        description: "The TLA+ model checker (TLC) is not installed or not in the system PATH.".to_string(),
        causes: vec![
        ...
        solutions: vec![
            "Install TLA+ tools from https://lamport.azurewebsites.net/tla/tools.html".to_string(),
    ...
    catalog.insert("FP-TL-002".to_string(), ErrorExplanation {
        title: "Tool Version Incompatible".to_string(),
        description: "The installed version of an external tool is not compatible with FerrisProof.".to_string(),
        causes: vec![
        ...
        examples: vec![
            "Required: TLC 1.7.0-1.8.x, Found: 1.6.2".to_string(),
        ],
        related_codes: vec!["FP-TL-001".to_string()],
    });
    
    // I/O Errors (FP-IO-xxx)
    catalog.insert("FP-IO-001".to_string(), ErrorExplanation {
        ...
        examples: vec![
            "File: specs/formal/protocol.tla\nError: Permission denied".to_string(),
        ],
